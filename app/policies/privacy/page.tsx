...
export default function PrivacyPage() {
  return (
    <PolicyShell eyebrow="PRIVACY NOTICE" title="隐私说明" summary="我们只为登录、身份确认、商品展示、站内聊天和平台安全处理必要信息。">
      <section>
        <h2>一、我们处理的信息</h2>
        <p>运营方为東北地区中国留学生学友会。平台可能处理登录邮箱、昵称、学术身份状态、商品文字和图片、交接地点、收藏、站内聊天、举报申诉以及必要的安全和邮件投递记录。</p>
        <p>邮箱不会显示在公开商品页面或站内聊天中。买卖双方通过匿名会话沟通；公开地图只显示发布者选择的交接点位，请勿填写家庭住址等精确私人地址。</p>
      </section>
      <section>
        <h2>二、保存期限</h2>
        ...
        <div className="policy-table-wrap"><table><thead><tr><th>信息类别</th><th>一般保存期限</th></tr></thead><tbody>
          <tr><td>账号、个人资料及学术身份状态</td><td>账号存续期间；注销申请核验后原则上 30 日内删除或匿名化。</td></tr>
          ...
          <tr><td>站内聊天及历史联系申请记录</td><td>相关商品关闭后最长 180 日；聊天媒体的实际保存期限同时受聊天服务商政策约束。</td></tr>
      ...
      <section>
        <h2>三、访问、更正、删除与注销</h2>
        <p>昵称和通知邮箱可在个人中心自行更正。申请访问、导出、更正或删除个人信息，或申请注销账号，请使用注册邮箱或已验证的通知邮箱发送邮件：</p>
        <ol>
      ...
      <section>
        ...
        <ul>
          ...
          <li><b>CometChat：</b>处理匿名会话所需的内部账号标识、文字、图片和语音消息，用于提供站内聊天、消息历史与未读状态；平台不会向聊天对方公开登录邮箱或真实姓名。<a href="https://www.cometchat.com/legal-privacy-policy" target="_blank" rel="noreferrer">查看隐私政策</a>。</li>
